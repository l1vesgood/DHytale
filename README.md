# DHytale - Hytale DiscordSRV-like Mod
...
- `src/main/java`: Plugin source code.
  - `dev.hytalemodding.ExamplePlugin`: Main plugin class.
  - `dev.hytalemodding.commands`: Custom command implementations.
  - `dev.hytalemodding.events`: Custom event listeners.
